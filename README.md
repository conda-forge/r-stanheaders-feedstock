...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-stanheaders-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-stanheaders-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-stanheaders
# for installing globally
pixi global install r-stanheaders
```
...
It is possible to list all of the versions of `r-stanheaders` available on your platform:
...
```
pixi search r-stanheaders --channel conda-forge
```
